...
/**
    ...
    @tags{Audio}
*/
class PapalotePluginHolder    : private AudioIODeviceCallback,
                                  private Timer,
...
public:
    ...
    */
    PapalotePluginHolder (PropertySet* settingsToUse,
    ...
    {
        // Only one PapalotePluginHolder may be created at a time
    ...
    static PapalotePluginHolder* getInstance()
    {
...
private:
    inline static PapalotePluginHolder* currentInstance = nullptr;
    ...
    {
    public:
        SettingsComponent (PapalotePluginHolder& pluginHolder,
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (PapalotePluginHolder)
};
...
/**
    ...
    @tags{Audio}
*/
class PapaloteFilterWindow    : public DocumentWindow
{
public:
    typedef PapalotePluginHolder::PluginInOuts PluginInOuts;

    PapaloteFilterWindow (const String& title,
                            Colour backgroundColour,
                            std::unique_ptr<PapalotePluginHolder> pluginHolderIn)
    ...
    */
    PapaloteFilterWindow (const String& title,
        ...
        : PapaloteFilterWindow (title,
                                  backgroundColour,
                                  std::make_unique<PapalotePluginHolder> (settingsToUse,
    ...
    // menu via PapalotePluginHolder::getInstance()->showAudioSettingsDialog().

    virtual PapalotePluginHolder* getPluginHolder()    { return pluginHolder.get(); }
...
private:
    ...
    {
    public:
        MainContentComponent (PapaloteFilterWindow& filterWindow)
    ...
    */
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (PapaloteFilterWindow)
};
